		...
		switch(choice)
		{
			...
			case 20:
			{
				while(choice != 99)
				{
					...
					{
						puts("Why does this person say they're your 4th grade English teacher? You don't eve remember them");
						...
						else if (choice == 2)
						{
							...
							puts("There is one thing you can try to do so you can redeem yourslrf though. A simle test that is");
							puts("Enter 1 to try one test, 2 to try the other");
							scanf("%d",&choice);
							if (choice == 1)
							{
								char string[25];
								int i;
								printf("\n Enter one really long word in all uppercase letters, no spaces ");
								scanf("%s", string);
							...
							else if (choice == 2)
							{
								char strin[25];
								int i;
								printf("\n enter one really long word in all lowercase letter, no space");
								scanf("%s",strin);
								...
								printf("\n The really long word you entered is now in upper case = %s \n",strin);
								puts("The only reason I had you do this was to make sure that you were paying attention");
							}
						}
					}
					else if (choice == 5)
					{
						char checkin[250];
						FILE *kbr;
						printf("Select a #, 1-4, and you will be given a question to answer. Your answer will be saved in a seperate file.");
						puts("For best results, start with question 1 and go down from there.");
						scanf("%d",&choice);
						if(choice == 1)
						{
...
void patrickInitialPrompt(void)
{
	...
	puts("4. Your 4th grade English teacher says they can help you wuth something. Select this option to see what they are talking about.");
