...
int main(int argc, char *argv[])
{
	...
	while(choice != 99)
	{
		...
		switch(choice)
		{
			...
			//random (DONE)
			//calculate an average (DONE)
			//separate functions
			//string functions
			//character functions (DONE)
			//file manipulation (DONE)
			//arrays
			//pointers
			{
				...
				char* ptr[256];
				int readFile;
				char string[20]; //array 19
				int length;
				FILE *rptr; //* pointer read
				...
				while(choice != 99)
				{
					...
					scanf("%s", string);
					for (i = 0; i < strlen(string); i++) // doing char function
				    {
						if(i % 1 == 0)
						{
					...
					puts("you hear the sound of water crashing in the distance, but can't quite make out where you are.. in the far off distance you see a small flicking light..");
					puts("1. Look around the entrance for any signs or clues");
					puts("2. You rush head-on towards the flicking light in hopes that it is an exit!");
					puts("3. You turn back from where you entered from");
					scanf("%d", &choice);
					
					if (choice == 1)
					{
						puts("You find a little bottle fill with a some sort of luminating substance");
						puts("I'll wait until I can see this in light..");
						puts("You placed it in your make-shift bag");
						counter++;
						
						puts("You slowly walk around and end up kicking a small object.. you pick it up and make out that it's a small dagger with what smelled of dried out blood.");
						puts("Might be smart to carry a weapon.");
						puts("You placed it in your make-shift bag");
						counter++;
						
						puts("What should I do now?");
						puts("1. Head towards the flicking light?");
						puts("2. Keep looking around the area?");
						puts("3. Go to sleep to rest up");
						scanf("%d", &choice);
						...
						switch(choice)
						{
							case 1:
							{
								puts("You cautiously creep towards the light");
								puts("You notice the rocky floor's moisture as you inch closer and closer to what seems like a waterfall and a body of water");
								puts("You reach the flicking light, there's a little box.. you decide to open it.");
								...
								else
								{
									while(choice != 4)
									{
										// readFile(readPtr, choice);
										puts("A figure grabs you from behind");
										printf("1. Scream \n");
										printf("2. Close eyes \n");
										...
										if(choice == 2)
										{
											...
											{
												fscanf(readPtr, "%s", name);
												printf("*%s shuts eyes tightly.. you have DIED\n", name);
												counter++;
												break;
										...
										if(choice == 3)
										{
											...
											{
												fscanf(readPtr, "%s", name);
												printf("*%s swings arms crazily, but you DIED..\n", name);
												counter++;
												break;
										...
										if(choice == 4)
										{
											...
											{
												fscanf(readPtr, "%s", name);
												puts("*%s calmly and sternly greet death..\n");
												counter++;
												choice = 99;
												break;
											}
							...
							case 2: 
							{
								...
								puts("Should I look for a boat near? I don't have much energy left, if I venture and get lost I'll die..");
								puts("1. Yes");
								puts("2. No");
								scanf("%d", &choice);
								...
								if(choice == 1)
								{
									...
									if(survival < 2)
									{
										puts("You wander around and don't find a boat.. you DIED from exhaustion");
										counter++;
									...
									{
										puts("You wander for a little bit and got lost.. starved and DIED\n ");
										counter++;
										break;
									}
									...
									{
										puts("You slip on the water rocky walkway and break your spine and DIED\n");
										counter++;
										break;
									}
									...
									{
										puts("You find the boat...a old man leaped and stabbed you in the neck.. you DIED\n");
										counter++;
										break;
									}
									...
									{
										puts("You find a plentory of dry goods and inventory of useful items, you ate the food and was poisoned.. therefore DIED\n");
										counter++;
										break;
									}
									...
									{
										puts("You decide not to and decide to go to sleep");
									}
									
									puts("When.. will I finally get out of this hellhold?");
								}
								counter++;
								break;
							}
							...
							case 3:
							{
								puts("You decide to lay down, feeling defeated you take the little mysterious bottle and down it..what's the worse that can happen?");
								
								choice = rand()%2 + 1;
								if (choice == 1)
								{
									puts("your body starts to feel warmer.. until you start to sweat and before you know it, your body self combust from the inside, burning you alive.. you DIED");
									counter++;
									break;
								}
								if (choice == 2)
								{
									puts("you feel strange, but nod it off and go to sleep anyways..... upon waking up you notice all your fatigue is gone!");
									counter++;
									break;
								}
					...
					{
						puts("You run quickly across the darkness, the sound of crashing water becomes louder and louder..\n");
						puts("You're squinting and started to make out what seems to be a human like figure near the light..\n");
						puts("You see what looks like a pit, but you're not sure.. do you jump? \n");
						puts("'Yes' or 'no'? \n");
						...
						*ptr = strstr (yes, no);
						...
						{
							strcpy(*ptr, yes);
							printf("You jumped over a pithole! I look to see there were wooden spikes laid all over the floor of it-  Whew!\n");
							printf("Yes you jumped! %s", yes);
							printf("but still DIED");
							choice = 99;
							counter++;
						}
						...
						{
							strcpy(*ptr, no);
							printf(".. but then %s stepped into a pithole into a handle of wooden spikes and impaled yourself..\n", names);
							printf("You didn't jump.. so you DIED %s", no);
							//continueStory();
							choice = 99;
							counter++;
					...
					{
						puts("You slowly close the heavy door to find a chill down your spine.. \n You jolt around quick and see an axe swinging towards your neck..and DIED \n");
						counter++;
						break;
					}
					...
					{
						puts("Try to survive again...");
					}
				}
				printf("Amount of decisions before you DIED = %d \n", counter);  //all the counters summed up here to see how long you survive
				printf("\n");
				printf("             ;::::;\n");
				printf("           ;::::; :;\n");
				printf("         ;:::::'   :;\n");
